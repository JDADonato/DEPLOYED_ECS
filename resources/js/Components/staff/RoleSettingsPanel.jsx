...
const RoleSettingsPanel = ({ role = 'admin', onNavigate, onToast }) => {
    ...
    const renderActiveSection = () => {
        ...
        if (activeSection === 'payments') return <section className="staff-settings-surface"><PaymentRulesPanel embedded onToast={onToast} /></section>;
