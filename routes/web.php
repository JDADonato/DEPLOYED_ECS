...
Route::get('/book', function () {
    ...
    $businessRules = \App\Models\BusinessRule::getActive();
    if (!$businessRules) {
        $businessRules = \App\Models\BusinessRule::create([
            'minimum_lead_days' => 7,
...
Route::middleware(['auth', 'role:Marketing,Admin'])->group(function () {
    ...
    Route::get('/api/settings/business-rules', [SettingsController::class, 'paymentRules']);
    ...
    Route::post('/api/marketing/bookings/{id}/transfer/request', [MarketingController::class, 'requestTransfer']);
    Route::post('/api/marketing/bookings/{id}/transfer/cancel', [MarketingController::class, 'cancelTransfer']);
    ...
    Route::post('/api/marketing/food-tastings/{tasting}/release', [FoodTastingController::class, 'staffRelease']);
    Route::post('/api/marketing/food-tastings/{tasting}/transfer/request', [FoodTastingController::class, 'staffRequestTransfer']);
    Route::post('/api/marketing/food-tastings/{tasting}/transfer/accept', [FoodTastingController::class, 'staffAcceptTransfer']);
    Route::post('/api/marketing/food-tastings/{tasting}/transfer/decline', [FoodTastingController::class, 'staffDeclineTransfer']);
    Route::post('/api/marketing/food-tastings/{tasting}/transfer/cancel', [FoodTastingController::class, 'staffCancelTransfer']);
    ...
    Route::patch('/api/settings/event-types/{id}/unarchive', [SettingsController::class, 'unarchiveEventType']);
    Route::delete('/api/settings/event-types/{id}/destroy', [SettingsController::class, 'destroyEventType']);
...
Route::middleware(['auth', 'role:Accounting,Admin'])->group(function () {
    ...
    Route::put('/api/accounting/bookings/{id}/acknowledge-change', [AccountingController::class, 'acknowledgeChangeOrder']);
    ...
    // New Workflows
    Route::post('/api/accounting/payments/{id}/receipt', [ReceiptController::class, 'store']);
});
...
Route::middleware(['auth', 'role:Admin'])->group(function () {
    ...
    Route::patch('/api/admin/event-types/{id}/unarchive', [SettingsController::class, 'unarchiveEventType']);
    Route::delete('/api/admin/event-types/{id}/destroy', [SettingsController::class, 'destroyEventType']);
